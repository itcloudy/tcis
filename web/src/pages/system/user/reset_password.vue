<template>
    <el-dialog  :visible="dialogResetPassword" width="25%" center :show-close="false" title="重置密码">
...
<script>
    ...
    export default {
        name:"reset_password",
        props:["userId","dialogResetPassword"],
        data(){
            ...
            confirmResetPassword(){
                this.$refs["resetPwd"].validate((valid)=>{
                    if(valid){
                        ...
                        this.$emit("dialogResetPasswordVisible");
                    } 
                });
        ...
        watch:{
            dialogResetPassword:function(){
                if (!this.dialogResetPassword){
