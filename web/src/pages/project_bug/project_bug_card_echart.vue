<template>
    <div :id="'bug-distribution-'+project.id" :style="chartStyle()">
    </div>
</template>
<script>
    import  {SERVER_PROJECT_BUG_INFO} from '@/server_address';
    export default {
        name:"project-bug-card-echart",
        ...
        methods:{
            getProjectBugInfo(){
                ...
                this.$ajax.get(SERVER_PROJECT_BUG_INFO,{
                        params:{
            ...
            echartDistributionView(){
                let echartDistributionChart = this.$echarts.init(document.getElementById("bug-distribution-"+this.project.id));
                let option ={
                    tooltip : {
                        trigger: 'axis',
                    ...
                    toolbox: {
                        ...
                        y:'center',
                        feature : {
                            saveAsImage : {show: true,name:"project_bug_bar"}
                        }
                    },
                    legend: {
